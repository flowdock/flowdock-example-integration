...
puts "\nNext we'll create a source for one or more of your flows."
puts "Please input the flow number. You can also use a comma separated list of flows (1,3,5) or hit enter to create a source in every flow.\n"
input = gets.chomp
...
puts "\nName for the source (Example: When integrating a project management tool, a source would represent a project.):\n"
